"""
Quantize the fixed ONNX model to INT8
Uses the re-exported ONNX model with correct shapes
"""
...
print("=" * 60)
print("ONNX INT8 Quantization (Fixed Model)")
print("=" * 60)
print()

# Paths
input_model = Path("mobile/assets/vit_model_fixed.onnx")
